    ...
    st.markdown(
        ...
        <style>
            ...
            .stApp:before {
                ...
                pointer-events: none;
                background-image:
                    linear-gradient(45deg, rgba(184,59,46,.035) 25%, transparent 25%),
                    linear-gradient(-45deg, rgba(34,87,122,.035) 25%, transparent 25%);
            ...
            .event-hero {
                ...
                border-radius: 34px;
                background:
                    linear-gradient(145deg, rgba(255,255,255,.86), rgba(255,248,231,.96));
            ...
            .section-kicker {
                ...
                padding: .28rem .68rem;
                border-radius: 999px;
                background: rgba(255,224,163,.76);
                color: #7b4100;
                font-size: .78rem;
                font-weight: 950;
                text-transform: uppercase;
            ...
            .turma-card {
                position: relative;
                background:
                    linear-gradient(145deg, rgba(255,255,255,.96), rgba(255,248,231,.98));
            ...
            div[data-testid="stVerticalBlockBorderWrapper"] {
                background:
                    linear-gradient(145deg, rgba(255,255,255,.82), rgba(255,248,231,.98));
            ...
            .gallery-empty-native {
                ...
                border-radius: 20px;
                background:
                    linear-gradient(145deg, rgba(255,255,255,.74), rgba(255,248,231,.92));
